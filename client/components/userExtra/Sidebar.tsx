...
const navigationItems = [
  { icon: BarChart3, label: "Dashboard", page: "dashboard" as NavigationPage },
  { icon: Search, label: "Keywords", page: "keywords" as NavigationPage },
  { icon: TrendingUp, label: "Analytics", page: "analytics" as NavigationPage },
  {
    icon: MessageSquare,
    label: "Comments",
    page: "comments" as NavigationPage,
  },
  { icon: Settings, label: "Settings", page: "settings" as NavigationPage },
];
